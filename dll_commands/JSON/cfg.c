...
void initMyJson(){
    ...
    myJson->snapshotData=(snapshot_t *)calloc(1,sizeof (snapshot_t));
    myJson->recordDeta=(record_t *)calloc(1,sizeof (record_t));
    myJson->recordDefultData=(record_t *)calloc(1,sizeof (record_t));

    myJson->buffer=(char*)calloc(800,sizeof(char));
    myJson->fp=NULL;
    myJson->snapshotDataDEFULT=(snapshot_t *)calloc(1,sizeof (snapshot_t));
...
void defultSnapshot(snapshot_t * snapshotDataDEFULT,snapshot_t* snapshotData){
...
void defultRecord(record_t * recordDataDefult,record_t* recordData){
